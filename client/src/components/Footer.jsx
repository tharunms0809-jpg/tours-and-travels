        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link to="/packages" className="hover:text-primary-400 transition-colors">Tour Packages</Link>
              </li>
              <li>
                <button
                  onClick={(e) => handleNavClick(e, 'about')}
                  className="hover:text-primary-400 transition-colors border-none bg-transparent p-0 cursor-pointer text-left text-gray-300 text-sm font-sans"
                >
                  About Us
                </button>
              </li>
