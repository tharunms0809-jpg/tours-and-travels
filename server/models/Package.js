...
const packageSchema = new mongoose.Schema({
  ...
  category: {
    type: String,
    enum: ['Adventure', 'Beach', 'Cultural', 'Hill Station', 'Wildlife', 'Pilgrimage', 'Honeymoon', 'Family', 'Luxury'],
    default: 'Cultural'
  },
  bestTimeToVisit: {
    type: String,
...
packageSchema.index({ title: 'text', destination: 'text', state: 'text', description: 'text' });
