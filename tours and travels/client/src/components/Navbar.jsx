      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#destinations" onClick={(e) => handleNavClick(e, 'destinations')} className={`font-medium hover:text-primary-500 transition-colors ${textColor}`}>Destinations</a>
            <a href="#about" onClick={(e) => handleNavClick(e, 'about')} className={`font-medium hover:text-primary-500 transition-colors ${textColor}`}>About</a>
          </div>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 shadow-lg animate-slide-down">
          <div className="px-4 py-4 space-y-3">
            ...
            <a href="#destinations" onClick={(e) => handleNavClick(e, 'destinations')} className="block py-2 text-gray-700 font-medium">Destinations</a>
            <a href="#about" onClick={(e) => handleNavClick(e, 'about')} className="block py-2 text-gray-700 font-medium">About</a>
            {user ? (
              <>
